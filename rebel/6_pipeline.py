...
# ------------------------------------------------------------------
# PRE-CHECK: Ensure Master.json exists and is for today's London date
# ------------------------------------------------------------------

def ensure_fresh_master():
    london_time = datetime.now(ZoneInfo("Europe/London"))
    today_str = london_time.strftime("%d %b %Y")  # e.g. "17 Dec 2025"
    ...
    try:
        ...
        # Empty or malformed Master.json → regenerate
